namespace InterfazUI
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            this.logTbx.Invoke(new Action(() => this.logTbx.AppendText($"{DateTime.Now} - {s}{Environment.NewLine}")));
        }

        public void AppendToContent(string s)
        {
            this.contentTxb.Invoke(new Action(() => this.contentTxb.AppendText($"{s}{Environment.NewLine}")));
        }
    }
}
